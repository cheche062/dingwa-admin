angular.module('ActiveStationController',['CommonService','ActiveService'])
       .controller('ActiveStationCtrl',['$scope','DictService','ActiveService','DialogService',
        function($scope,DictService,ActiveService,DialogService){
            ...
            $scope.add = function(){
                ...
                if(!(/^\d+$/).test($scope.addContent.payment_fix)){
                ...
                var condition = {
                    ...
                    payment_fix:$scope.addContent.payment_fix,
            ...
            $scope.update = function(){
                ...
                //     }
                // }
                if(!(/^\d+$/).test($scope.editContent.payment_fix)){
                    DialogService.alert('请输入正确的赠送次数')
                    return false
                }
                ...
                var condition = {
                    ...
                    payment_fix:$scope.editContent.payment_fix,
